        ...
        <div className="container max-w-4xl mx-auto text-center z-10">
            <div className="space-y-6">
                <h1 className="tex-4xl md:text-6xl font-bold">
                    ...
                    <span className="text-primary opacity-0 animate-fade-in-delay-1"> SONU</span>
                    <span className="text-secondary opacity-0 animate-fade-in-delay-2"> Kumar Napit</span>
                    
                </h1>

                <p className="text-lg md:text-xl text-muted-foreground text-secondary max-2-2xl mx-auto opacity-0 animate-fade-in-delay-3">
                   I build modern and responsive web applications with strong skills in Frontend, Backend, DSA, and DevOps tools like CI/CD, Docker, and Kubernetes.
I focus on creating interfaces that are fast, clean, and functional, backed by real project experience.
                </p>
            </div>
